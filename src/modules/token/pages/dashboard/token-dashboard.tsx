        ...
        <MainContent>
            ...
            <Card style={{ width: '100%' }}>
                ...
                <div>
                    ...
                    <p className='text-gray-800 fw-normal mb-5 fs-6' >{(tokenData as Token)?.basicInfo?.description ? (tokenData as Token)?.basicInfo?.description : <span>Are you the project owner? Please <a className="text-hover-primary" href="https://t.me/RoyalProofAdmin">click here</a> to add all the missing information about your project!</span>}</p>
